...
public class Layout implements Copyable<Layout>, Serializable {
    ...
    public static class Attribute implements Copyable<Attribute>, Serializable {
        ...
        public static class Mutable extends Attribute {
            ...
            public Attribute.Mutable set(Object a) {
                mSet(a);
                return this;
            }
            ...
            public Attribute.Mutable set(Number a) {
                mSet(a);
                return this;
            }
    
            public Attribute.Mutable set(float...  a) {
                mSet(a);
                return this;
            }
            ...
            public static Attribute.Mutable fromString(String s) {
                return Attribute.fromString(new Attribute.Mutable(), s);
            }
        }
    }
